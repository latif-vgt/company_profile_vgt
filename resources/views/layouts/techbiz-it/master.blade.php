        ...
        <div class="vs-menu-wrapper">
            <div class="vs-menu-area text-center">
                ...
                <div class="mobile-logo">
                    <a href="{{ route('welcome') }}"><img src="{{ URL::asset('vgt/no-black-vgt.png') }}" alt="VisiGlobalTeknologi" class="logo"></a>
                </div>
                    ...
                    <div class="row justify-content-between align-items-center gx-sm-0">
                        <div class="col">
                            <div class="header-logo">
                                <a href="{{ route('welcome') }}"><img style="width: 210px; height:100%" src="{{ URL::asset('vgt/no-black-vgt.png') }}" alt="VisiGlobalTeknologi" class="logo"></a>
                            </div>
                        </div>
