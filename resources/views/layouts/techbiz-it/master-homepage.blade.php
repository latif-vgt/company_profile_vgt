        ...
        <div class="vs-menu-wrapper">
            <div class="vs-menu-area text-center">
                ...
                <div class="mobile-logo">
                    <a href="{{ route('welcome') }}"><img src="{{ URL::asset('vgt/white-vgt.png') }}" alt="VisiGlobalTeknologi" class="logo"></a>
                </div>
                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-auto">
                                    <div class="logo-style1">
                                        <a href="{{ route('welcome') }}"><img style="width: 210px; height:100%" src="{{ URL::asset('vgt/white-vgt.png') }}" alt="VisiGlobalTeknologi" class="logo"></a>
                                    </div>
                                </div>
                                <div class="col-auto">
